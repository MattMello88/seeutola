    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column mt-3" id="v-pills-tab">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link link-dark" aria-current="page" id="v-pills-site-tab" data-bs-toggle="pill" data-bs-target="#v-pills-site" type="button" role="tab" aria-controls="v-pills-site" aria-selected="true">
          ...
          <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
            ...
            <div class="px-4 pt-5 my-5 text-center border-bottom">
              ...
              <div class="col-lg-6 mx-auto">
                <p class="lead mb-4">
                  Realize a configuração do seu site
                </p>
              </div>
            </div>
