    ...
    <div class="bg-secondary p-2 text-dark bg-opacity-10" id="agenda">
      <div class="container my-5 text-center border-bottom">
        ...
        <div class="row" id="agendas">
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 mb-5">
            <div class="card" >
              <img src="{{url('assets/img/convidados/2.jpg')}}" class="img-thumbnail img-fluid card-img-top" alt="" width="100%" height="300">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-4 mb-5">
            <div class="card" >
              <img src="{{url('assets/img/convidados/4.jpg')}}" class="img-thumbnail img-fluid card-img-top" alt="" width="100%" height="300">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
